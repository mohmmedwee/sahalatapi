...
if(canAccess('admin.notification.allData')) {

}elseif(canAccess('admin.notification.groupData')){
$oResults = $oResults->where('notification.users_id','=',  current_user()->getUser()->id);
}elseif(canAccess('admin.notification.userData')){
