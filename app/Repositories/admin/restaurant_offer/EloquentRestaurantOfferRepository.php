<?php
namespace App\Repositories\admin\restaurant_offer;

use Session;
use App\Models\RestaurantOffer;
use App\Repositories\admin\restaurant_offer\RestaurantOfferContract;
...
class EloquentRestaurantOfferRepository implements RestaurantOfferContract
{
    ...
    public function getByFilter($data,&$statistic=null)
    {
        ...
        $oResults =  RestaurantOffer::with("restaurant",'offer');
