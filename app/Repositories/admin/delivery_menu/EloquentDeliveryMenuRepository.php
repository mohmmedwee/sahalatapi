<?php
namespace App\Repositories\admin\delivery_menu;

use Session;
use App\Models\DeliveryMenu;
use App\Repositories\admin\delivery_menu\DeliveryMenuContract;
...
class EloquentDeliveryMenuRepository implements DeliveryMenuContract
{
    ...
    public function getByFilter($data)
    {
        ...
        if(canAccess('admin.delivery_menu.allData')) {

        }elseif(canAccess('admin.delivery_menu.groupData')){
            $oResults = $oResults->whereIn('restaurant_id', current_user()->getRestaurant());
        }elseif(canAccess('admin.delivery_menu.userData')){
