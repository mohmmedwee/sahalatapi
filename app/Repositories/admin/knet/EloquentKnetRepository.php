<?php
namespace App\Repositories\admin\knet;

use Session;
use App\Models\Knet;
use App\Repositories\admin\knet\KnetContract;
...
$knet = Knet::findOrFail($id);
    ...
    public function exportExcel($request){
        ...
        \Excel::create('knet', function($excel) use($excelData) {
    ...
    public function billToArray($oResults){
        $aResults=[['id','payment_id','users_id','order_id','amount','PaymentID','Result','PostDate','TranID','Auth','Ref','TrackID','UDF1','UDF2','UDF3','UDF4','UDF5','created_at','updated_at']];
