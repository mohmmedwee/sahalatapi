<?php
namespace App\Repositories\admin\deliver_package;

use Session;
use App\Models\DeliverPackage;
use App\Repositories\admin\deliver_package\DeliverPackageContract;
...
class EloquentDeliverPackageRepository implements DeliverPackageContract
{
    ...
    public function getCorrespondOrderPackage($ordersNumber){

        $oResults = DeliverPackage::where('deliver_number','<=',$ordersNumber)->orderBy('deliver_number','desc')->first();
