...
namespace App\Http\Controllers\admin\restaurant_offer;
...
use App\Http\Requests\admin\restaurant_offer\createRequest;
use App\Http\Requests\admin\restaurant_offer\editRequest;
use Session;
...
class RestaurantOffer extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.restaurant_offer.index', compact('oResults','request','statistic'));
    }
...
$offerList=$rOffer->getAllList();
        ...
        return view('admin.restaurant_offer.create',compact('request','restaurantList','offerList'));
    }
    ...
    public function store(createRequest $request)
    {
        ...
        return redirect('admin/restaurant_offer');
    }
    ...
    public function show($id,Request $request)
    {
      ...
      $request->merge(['restaurant_offer_id'=>$id,'page_name'=>'page']);
        ...
        return view('admin.restaurant_offer.show', compact('restaurant_offer','request'));
    }
 ...
 $restaurantList=$rRestaurant->getAllList();
 $offerList=$rOffer->getAllList();
        return view('admin.restaurant_offer.edit', compact('restaurant_offer','restaurantList','offerList'));
    }
